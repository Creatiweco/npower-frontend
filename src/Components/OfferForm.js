    ...
    <div className="form-area" style={{ marginTop: "55px" }}>
      <div className="container form-container">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="custom-select">
                <select
                  ...
                  required
                >
                  <option value="" disabled selected>{t("form.generatorPower")}</option>
              ...
              <div className="custom-select">
                <select
                  ...
                  required
                >
                  <option value="" disabled selected>{t("form.generatorEngine")}</option>
          ...
          <button className="form-button" type="submit">{t("form.send")}</button>
        </form>
      </div>
    </div>
  );
